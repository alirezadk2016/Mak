export const t = {
  ...
  en: {
    ...
    about: {
      heading: 'About me',
      bio: 'Before coming to Denmark, I spent nearly two years working in web development, SEO and digital marketing in Iran. When I arrived in Denmark, I learned the language and joined YouSee through an IGU programme, where I built solid experience in customer service and IT administration — and was later permanently employed. To further develop my skills and deepen my IT knowledge, I chose to study at Aarhus Tech alongside work. This led to an internship at Fourcom, where I gained hands-on experience in professional IT support. Today I am newly qualified and ready for the next step. I always stay up to date, work well in teams and enjoy finding solutions — whether for a young colleague or an elderly user. I am driven, adaptable and ready to contribute from day one.',
      stats: [
